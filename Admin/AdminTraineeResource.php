                                                ...
                                                <ul class="pagination pagination-sm">
                                                    ...
                                                    <li class="page-item m-1 text-bg-dark"><small
                                                            class="text-warning text-center mx-1">Showing <span
                                                                id="CurrentPage"></span> to <span id="TotalPage"></span>
                                                            of
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    <td class="text-truncate text-center">
                                        <a title="Evaluate This Account" id="Evaluate" class="btn btn-success btn-sm"><img src="../Image/documents.svg" alt="Evaluate" style="width: 25px; height: 25px;"></a>
                                        </td>
                                    </tr>
                                    ...
                                    Evaluate[' . ($i - 1) . '].addEventListener("click", () => {
                                        window.location.href = "../Components/Resource.php?ID=' . $row['UID'] . '";
                                    });
                                    </script>
                                    ';
                                        $i++;
