                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control text-bg-light" id="CreUSN" name="CreUSN"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content text-bg-light">
            ...
            <div class="modal-body">
                ...
                <!-- notice -->
                <p class="blockquote-footer">You can't View the <span class="text-success">Password</span> of this
